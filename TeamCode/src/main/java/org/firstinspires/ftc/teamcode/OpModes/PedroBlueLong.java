...
@Autonomous(name = "BlueLong", group = "Examples")
public class PedroBlueLong extends LinearOpMode {
...
//    public HardwareMap hwmap;
    ...
    private final Pose startPose = new Pose(47, 8, Math.toRadians(90)); // Needs new angle Start Pose of our robot.
    private final Pose scorePose = new Pose(57,15 , Math.toRadians(110)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose PrescorePose = new Pose(60, 20, Math.toRadians(25)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    ...
    private final Pose endPose = new Pose(50, 53, Math.toRadians(25)); //  End Position of the Robot
